<div class="card">
  ...
  <div class="card-header">
    <h3 class="mb-0">Data C8</h3>
  </div>
  <div class="container">
    <div class="table-responsive py-4">
      <table class="table table-flush" id="data-c8">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM c8
                  LEFT JOIN tb_user ON c8.user_id = tb_user.id";
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                |
                <a class="btn btn-sm btn-default" href="javascript:hapusData_c8('<?= $hasil['id']; ?>')">
  ...
  if (in_array($fileActualExt, $allowed)) {
    if ($fileError === 0) {
      if ($fileSize < 100000000) {
        ...
        $sql = mysqli_query($link, "UPDATE `c8` SET `file_c8` = '$fileNewName', `tgl_upload` = '$tgl' WHERE `c8`.`id` = $id");
        if ($sql) {
