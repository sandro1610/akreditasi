<div class="card">
  ...
  <div class="card-header">
    <h3 class="mb-0">Data C2</h3>
  </div>
  <div class="container">
    <div class="table-responsive py-4">
      <table class="table table-flush" id="data-c2">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM c2
                  LEFT JOIN tb_user ON c2.user_id = tb_user.id";
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                |
                <a class="btn btn-sm btn-default" href="javascript:hapusData_c2('<?= $hasil['id']; ?>')">
  ...
  if (in_array($fileActualExt, $allowed)) {
    if ($fileError === 0) {
      if ($fileSize < 100000000) {
        ...
        $sql = mysqli_query($link, "UPDATE `c2` SET `file_c2` = '$fileNewName', `tgl_upload` = '$tgl' WHERE `c2`.`id` = $id");
        if ($sql) {
