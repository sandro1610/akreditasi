...
if (isset($_POST["Submit_user"])) {
  ...
  $sql = mysqli_query($link, "INSERT INTO tb_user(nama, nip, password, level) VALUES ('$nama', '$nip', '$password', 'user')");
  if ($sql) {
              ...
              <form role="form" method="POST">
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="nama" placeholder="Nama" type="nama">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                ...
                <div class="text-center">
                  <button class="btn btn-primary mt-4" name="Submit_user" type="submit">Sign Up</button>
                </div>
              </form>
            </div>
          </div>
